...
<body>
  ...
  <div class="card mx-auto mt-4 col-lg-4 col-md-6 col-sm-8 shadow">
    <div class="card-body">
      <form action="tabel.php" method="post">
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Jumlah baku</label>
          <input type="text" class="form-control" name="bahan_baku" id="exampleInputEmail1" aria-describedby="emailHelp" required>
        </div>
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Jumlah produk</label>
          <input type="text" class="form-control" name="produk" id="exampleInputEmail1" aria-describedby="emailHelp" required>
        </div>
